...
d_subset_long <-
  d_subset |> pivot_longer(cols = starts_with("e_"), names_to = "variable", values_to = "value")
d_subset_long |> print (n=3)
```
...
#### Prerequisite of bind_cols

Have the same rows

```{r}
d_Vdem1945 <- read.csv("_DataPublic_/vdem/1945_1983/vdem_1945_1983_external.csv")
```
...
#### What if bind_rows two dataset with different columns?

The extra column would become NA for the empty dataset.

#### Comparison

bind_rows more safer than bind_cols
